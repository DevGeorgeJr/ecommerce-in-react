...
const NavMenuDesktop = () => {
  ...
  return (
    <Fragment>
          ...
          <Container fluid={true} className="fixed-top shadow-sm p-2 mb-0 bg-white">
            <Row>
              <Col lg={4} md={4} sm={12} xs={12}>
                <Button onClick={handleMenuBarClick} className="btn"><i className="fa fa-bars"></i></Button>
                <Link to="/"><img className="nav-logo" src={Logo} alt="EasyShop" /></Link>
              </Col>
      ...
      <div onClick={handleContentOverlayClick} className={contentOverState}>
      </div>
    </Fragment>
  );
}
